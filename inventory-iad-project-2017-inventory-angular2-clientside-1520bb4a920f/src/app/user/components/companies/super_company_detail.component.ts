...
@Component({
    selector: 'super_company_detail',
    templateUrl: '../../templates/companies/super_company_detail.component.html',
    styleUrls: ['../../stylesheets/companies/super_company_detail.component.css']
})
export class SuperCompanyDetailComponent {
    username: string;
  /*
