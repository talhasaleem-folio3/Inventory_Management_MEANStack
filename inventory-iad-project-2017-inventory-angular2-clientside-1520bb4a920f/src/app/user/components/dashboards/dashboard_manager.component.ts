...
@Component({
  selector: 'dash_manager',
  templateUrl: '../../templates/dashboards/dashboard_manager.component.html',
  styleUrls: ['../../stylesheets/dashboards/dashboard_manager.component.css']
})
