...
@Component({
    selector: 'employee_invoice_edit',
    templateUrl: '../../../templates/invoices/employee/employee_invoice_edit.component.html',
    styleUrls: ['../../../stylesheets/invoices/employee/employee_invoice_edit.component.css']
})
export class EmployeeInvoiceEditComponent {
    username: string;
  /*
