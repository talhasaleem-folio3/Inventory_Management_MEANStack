...
@Component({
    selector: 'super_invoice_detail',
    templateUrl: '../../../templates/invoices/super/super_invoice_detail.component.html',
    styleUrls: ['../../../stylesheets/invoices/super/super_invoice_detail.component.css'],
    providers: [InvoicesServices]
})
export class SuperInvoiceDetailComponent {
    username: string;
    invoice: Invoiceinfo[];
    invoices: string;
    flag: AboutInvoice;
