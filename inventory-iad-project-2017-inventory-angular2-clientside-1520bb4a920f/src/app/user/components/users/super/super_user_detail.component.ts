...
@Component({
    selector: 'super_user_detail',
    templateUrl: '../../../templates/users/super/super_user_detail.component.html',
    styleUrls: ['../../../stylesheets/users/super/super_user_detail.component.css']
})
export class SuperUserDetailComponent {
    username: string;
  /*
